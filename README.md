...
- **프론트엔드 개발**
	- Tanstack query로 강의실, 강의, 피드백, 수강생 관리, 북마크 API 연결
	- BlockNote, SSE, Zustand를 이용한 AI 편집 기능 개발
	- OAuth 로그인 및 middleware.ts를 이용한 자동 로그인 페이지 라우팅 개발
	- 확장 프로그램
		- STT 연결, 로그인 상태 동기화
